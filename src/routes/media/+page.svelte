...
<section class="section">
	<div class="container">
		...
		<div class="max-w-3xl mx-auto">
			...
			<div class="card mb-8">
				<h2 class="text-2xl font-bold mb-4 text-primary">Latest Updates</h2>
				<div class="space-y-4">
			...
			<div class="card">
				<h2 class="text-2xl font-bold mb-4 text-primary">Follow Us</h2>
				<p class="text-text-light mb-4">
					Connect with us on social media to stay updated with all our latest news and activities.
				</p>
