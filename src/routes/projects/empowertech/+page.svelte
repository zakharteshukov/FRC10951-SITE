		...
		<div class="max-w-3xl mx-auto">
			<div class="card mb-8">
				<div class="image-container mb-6">
					<img src="/empowertech.webp" alt="EmpowerTech" class="w-full rounded-lg" loading="lazy" decoding="async" />
				</div>
			...
			<div class="card mb-8">
				...
				<ul class="list-disc list-inside space-y-2 text-text-light mb-4">
					<li>Provide accessible technology education to underserved communities</li>
					<li>Foster innovation and problem-solving skills</li>
					<li>Create opportunities for hands-on learning and experimentation</li>
					<li>Build partnerships with schools and community organizations</li>
					<li>Inspire students to pursue careers in STEM fields</li>
				</ul>
			</div>
